...
insert into books (price, deleted, supplier_id, title, author, isbn, pages) values ( 10, false, '399', 'Book1', 'Author1', '123', 200);
insert into books (price, deleted, supplier_id, title, author, isbn, pages) values ( 12, false, '399', 'Book2', 'Author2', '1234', 300);
insert into books (price, deleted, supplier_id, title, author, isbn, pages) values ( 12, false, '399', 'Either/Or', 'Søren Kierkegaard', '12346', 300);
insert into books (price, deleted, supplier_id, title, author, isbn, pages) values ( 12, false, '399', 'Repetition', 'Soren Kierkegaard', '12345', 300);
insert into games (price, deleted, supplier_id, title, genre, minage, publisher) VALUES (10, false, '323', 'World of Warcraft', 'MMORPG', 12,  'Blizzard Entertainment');
insert into games (price, deleted, supplier_id, title, genre, minage, publisher) VALUES (10, false, '323', 'World of Warcraft:Cataclysm', 'MMORPG', 12, 'Blizzard Entertainment');
insert into games (price, deleted, supplier_id, title, genre, minage, publisher) VALUES (10, false, '323', 'World of Warcraft:Wrath of Lichy Kung', 'MMORPG', 12,  'Blizzard Entertainment');
insert into lps (price, deleted, supplier_id, title, artist, genre) VALUES (15, false, '299', 'Innuendo', 'Queen', 'rock');
insert into lps (price, deleted, supplier_id, title, artist, genre) VALUES (15, false, '299', 'Dark Side Of The Moon', 'Pink Floyd', 'rock');
insert into lps (price, deleted, supplier_id, title, artist, genre) VALUES (13, false, '999', 'Dave Brubeck', 'Take Five', 'classic');
