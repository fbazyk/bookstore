...
create table books (id  bigserial not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, deleted boolean default false, price numeric(19, 2) not null, search_title varchar(255), supplier_id varchar(100) not null, title varchar(255) not null, author varchar(100), isbn varchar(255) not null, pages int8, article_id int8, primary key (id))
create table games (id  bigserial not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, deleted boolean default false, price numeric(19, 2) not null, search_title varchar(255), supplier_id varchar(100) not null, title varchar(255) not null, genre varchar(255), minage int8, publisher varchar(100), article_id int8, primary key (id))
create table generic_entity (id int8 not null, value varchar(255), primary key (id))
create table lps (id  bigserial not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, deleted boolean default false, price numeric(19, 2) not null, search_title varchar(255), supplier_id varchar(100) not null, title varchar(255) not null, artist varchar(100) not null, genre varchar(255), article_id int8, primary key (id))
...
create table orders (order_id int8 not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, cart_date timestamp, order_date timestamp, order_total numeric(19, 2), shipping_date timestamp, version int4, user_id int8, primary key (order_id))
...
alter table books add constraint FKjia6f8hobi296hiss6lej8gu9 foreign key (article_id) references storage_location
alter table games add constraint FK2gdtkmda6utxbfsiux14sbmsx foreign key (article_id) references storage_location
alter table lps add constraint FK2cc27i2r0qbivi5voamm4sd44 foreign key (article_id) references storage_location
...
insert into storage_location(article_id, article_type, code, level, row, segment)
create sequence hibernate_sequence start 1 increment 1
create table address (id  bigserial not null, city varchar(255), country varchar(255), number varchar(255), postcode varchar(255), street varchar(255), primary key (id))
