...
create sequence hibernate_sequence start 1 increment 1
    ...
    alter table reviews 
       ...
       foreign key (article_id) 
       references lps
insert into users (username, enabled, first_name, last_name, role) values ('andy', 1, 'Andy', 'Warhall', 'ADMIN')
insert into users (username, enabled, first_name, last_name, role) values ('soren', 1, 'Soren', 'Kierkjegaard', 'USER')
insert into books (price, supplier_id, title, author, isbn, pages) values ( 10, '399', 'Book1', 'Author1', '123', 200)
insert into books (price, supplier_id, title, author, isbn, pages) values ( 12, '399', 'Book2', 'Author2', '1234', 300)
insert into books (price, supplier_id, title, author, isbn, pages) values ( 12, '399', 'Either/Or', 'Søren Kierkegaard', '12346', 300)
insert into books (price, supplier_id, title, author, isbn, pages) values ( 12, '399', 'Repetition', 'Soren Kierkegaard', '12345', 300)
...
create sequence hibernate_sequence start 1 increment 1
    ...
    alter table reviews 
       ...
       foreign key (article_id) 
       references lps
insert into users (username, enabled, first_name, last_name, role) values ('andy', true, 'Andy', 'Warhall', 'ADMIN')
insert into users (username, enabled, first_name, last_name, role) values ('soren', true, 'Soren', 'Kierkjegaard', 'USER')
insert into books (price, supplier_id, title, author, isbn, pages) values ( 10, '399', 'Book1', 'Author1', '123', 200)
insert into books (price, supplier_id, title, author, isbn, pages) values ( 12, '399', 'Book2', 'Author2', '1234', 300)
insert into books (price, supplier_id, title, author, isbn, pages) values ( 12, '399', 'Either/Or', 'Søren Kierkegaard', '12346', 300)
insert into books (price, supplier_id, title, author, isbn, pages) values ( 12, '399', 'Repetition', 'Soren Kierkegaard', '12345', 300)
