...
create table books (id  bigserial not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, price numeric(19, 2) not null, search_title varchar(255), supplier_id varchar(100) not null, title varchar(255) not null, author varchar(100), isbn varchar(255) not null, pages int8, primary key (id))
create table games (id  bigserial not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, price numeric(19, 2) not null, search_title varchar(255), supplier_id varchar(100) not null, title varchar(255) not null, genre varchar(255), minage int8, publisher varchar(100), primary key (id))
create table generic_entity (id int8 not null, value varchar(255), primary key (id))
create table lps (id  bigserial not null, created_by varchar(255), created_on timestamp, updated_by varchar(255), updated_on timestamp, price numeric(19, 2) not null, search_title varchar(255), supplier_id varchar(100) not null, title varchar(255) not null, artist varchar(100) not null, genre varchar(255), primary key (id))
