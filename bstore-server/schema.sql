...
create table order (order_id int8 not null, cart_date timestamp, order_date timestamp, user_id int8, primary key (order_id))
create table order_item (id int8 not null, article_id int8, price numeric(19, 2), quantity int8, order_id int8, primary key (id))
create table reviews (id  bigserial not null, rating int4, text varchar(255), article_id int8, primary key (id))
...
alter table order add constraint FKs9p0s8b1nh7m2no87xxteu83x foreign key (user_id) references users
alter table order_item add constraint FKt6wv8m7eshksp5kp8w4b2d1dm foreign key (order_id) references order
...
create table lps (id  bigserial not null, price numeric(19, 2) not null, supplier_id varchar(100) not null, title varchar(100) not null, artist varchar(100) not null, genre varchar(255), primary key (id))
create table order_item (id int8 not null, article_id int8, price numeric(19, 2), quantity int8, order_id int8, primary key (id))
create table orders (order_id int8 not null, cart_date timestamp, order_date timestamp, user_id int8, primary key (order_id))
create table reviews (id  bigserial not null, rating int4, text varchar(255), article_id int8, primary key (id))
create table users (id  bigserial not null, first_name varchar(100) not null, last_name varchar(100) not null, password varchar(255), role varchar(255), primary key (id))
alter table books add constraint books_unique unique (isbn)
